...
<div class="col-lg-8 col-md-6 col-sm-12 offset-lg-2" >
  ...
  <div class="card card-body">
    ...
    <form class="user" action="adminprofpost.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input minlength="1" type="Password" name="password" class="form-control form-control-user" placeholder=" Enter your Password" required="">
      </div>
